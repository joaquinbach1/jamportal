...
/* Edge y no serverless. En serverless la función se puede probar local, pero
   instanciar resvg.wasm (1,4 MB) en cada arranque en frío se pasa del límite:
   probado con 15s/1 GB y con 60s/1,7 GB, en frío y en caliente, siempre 504.
   En edge el runtime ya lo tiene instanciado y no hay que pagar ese arranque. */
...
/* 10 y no 11: con 11 el último renglón queda cortado contra el borde de
   abajo. Alto útil ≈ 361px y cada renglón ≈ 33px. */
...
function renglon(n, texto) {
  return el('div', {
    ...
    el('div', {
      color: ACC, fontSize: 19, fontFamily: 'monospace',
      width: 32, textAlign: 'right', flexShrink: 0,
    }, String(n)),
    el('div', {
      color: TXT, fontSize: 22, whiteSpace: 'nowrap',
