...
export const store = {
  ...
  addSong(data) {
    const song = {
      ...
      cantantes: [], patches: [], invitados: [], jams: [], anio: null, album: '', albumId: null, cover: '', vientos: false, coros: false,
      notas: '', origen: 'manual',
      ...data,
    };
    ...
    for (const r of rows) {
      ...
      if (found && (completaElArtista || norm(found.artista) === norm(r.artista || found.artista))) {
        ...
        state.songs.push({
          ...
          bpm: null, bpmRaw: '', franja: null, cantantes: [], patches: [], invitados: [], jams: [], anio: null, album: '', albumId: null, cover: '', vientos: false, coros: false,
